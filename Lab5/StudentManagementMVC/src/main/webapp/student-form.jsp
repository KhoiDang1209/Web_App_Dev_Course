...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Optional: Highlight the input border red if there is an error */
        .is-invalid {
...
<body>
    <div class="container">
        ...
        <form action="student" method="POST">
            <input type="hidden" name="action" value="${student != null && student.id > 0 ? 'update' : 'insert'}">
            <c:if test="${student != null && student.id > 0}">
                <input type="hidden" name="id" value="${student.id}">
            </c:if>
            
            <div class="form-group">
                <label for="studentCode">Student Code <span class="required-mark">*</span></label>
                <input type="text" 
                       id="studentCode" 
                       name="studentCode" 
                       class="${not empty errorCode ? 'is-invalid' : ''}"
            ...
            <div class="form-group">
                <label for="major">Major <span class="required-mark">*</span></label>
                <select id="major" name="major" class="${not empty errorMajor ? 'is-invalid' : ''}">
